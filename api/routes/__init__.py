...
from api.routes import queries, clues, entities, feedback, system, taxonomy, metrics, evolution, export, channels, seed_words, conversations, kg
...
router.include_router(kg.router, tags=["知识图谱"])