...
class SlangMapping:
    ...
    source: str = "preset"  # preset/learned/manual
    verified: bool = False
...
class Proposal:
    ...
    proposal_id: str
    proposal_type: str  # noise_whitelist/classification_rule/seed_word
    title: str
    detail: str
...
class Channel:
    ...
    platform: str
    platform_name: str
    category: str  # im/social/vertical
    status: str = "unconfigured"  # connected/disconnected/error/unconfigured
    enabled: bool = False
